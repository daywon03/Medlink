...
export class SupabaseService {
   ...
   */
  async createOrUpdateTriageReport(
    call_id: string,
    triageData: {
      ...
      const { data, error } = await this.supabase
        ...
        .update({
          ...
          nearest_hospital_data: triageData.nearestHospital
            ...
            : null,
          fire_station_data: triageData.nearestFireStation
            ? JSON.stringify(triageData.nearestFireStation)
            : null,
          patient_location: triageData.patientLocation
